...
function flushCallbacks$1(vm) {
    if (vm.__next_tick_callbacks && vm.__next_tick_callbacks.length) {
        if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"球馆预约","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var composition_api_1 = __webpack_require__(/*! @vue/composition-api */ 10);
var app = __webpack_require__(/*! ./app */ 12);
var mp = __webpack_require__(/*! ./mp */ 13);
var uts_1 = __webpack_require__(/*! ./uts */ 14);
...
if (false) {} else {
  module.exports = __webpack_require__(/*! ./dist/vue-composition-api.common.js */ 11)
}
...
var _construct2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/construct */ 26));
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ 29));
...
var setPrototypeOf = __webpack_require__(/*! ./setPrototypeOf.js */ 27);
var isNativeReflectConstruct = __webpack_require__(/*! ./isNativeReflectConstruct.js */ 28);
...
var arrayWithoutHoles = __webpack_require__(/*! ./arrayWithoutHoles.js */ 30);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 15)["default"], __webpack_require__(/*! ./../../../webpack/buildin/global.js */ 5)))
...
/* 46 */
/*!************************************************!*\
  !*** D:/项目/球馆/miniapp/composables/useVenue.ts ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.useSportType = useSportType;
...
var _venue = __webpack_require__(/*! @/api/venue */ 50);
function useVenue() {
  var venues = (0, _vue.ref)([]);
  var currentVenue = (0, _vue.ref)(null);
  var loading = (0, _vue.ref)(false);
  var loadVenues = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return (0, _venue.getVenueList)();
            case 4:
              venues.value = _context.sent;
              _context.next = 10;
              break;
            case 7:
              _context.prev = 7;
    ...
    return function loadVenues() {
      return _ref.apply(this, arguments);
    };
  }();
  var loadVenueDetail = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return (0, _venue.getVenueDetail)(id);
            case 4:
              currentVenue.value = _context2.sent;
              _context2.next = 10;
              break;
            case 7:
              _context2.prev = 7;
    ...
    return function loadVenueDetail(_x) {
  ...
  return {
    ...
    loadVenueDetail: loadVenueDetail
  };
}
function useTimeSlots() {
  var slots = (0, _vue.ref)([]);
  var loading = (0, _vue.ref)(false);
  var loadSlots = /*#__PURE__*/function () {
    var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3(venueId, courtId, date) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return (0, _venue.getTimeSlots)(venueId, courtId, date);
            case 4:
              slots.value = _context3.sent;
              _context3.next = 10;
              break;
            case 7:
              _context3.prev = 7;
    ...
    return function loadSlots(_x2, _x3, _x4) {
...
function useSportType() {
  ...
  var getSportTypeName = function getSportTypeName(type) {
    return sportTypeMap[type] || type;
  };
  return {
    getSportTypeName: getSportTypeName
  };
}
...
exports.getVenueList = exports.getVenueDetail = exports.getTimeSlots = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 51));
var getVenueList = function getVenueList() {
  return (0, _request.default)({
    url: '/venues'
  });
};
exports.getVenueList = getVenueList;
var getVenueDetail = function getVenueDetail(id) {
  return (0, _request.default)({
    url: "/venues/".concat(id)
  });
};
exports.getVenueDetail = getVenueDetail;
var getTimeSlots = function getTimeSlots(venueId, courtId, date) {
  return (0, _request.default)({
    url: "/venues/".concat(venueId, "/courts/").concat(courtId, "/slots"),
    data: {
      date: date
    }
  });
...
/* 51 */
/*!*****************************************!*\
  !*** D:/项目/球馆/miniapp/utils/request.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.isVenueOpen = exports.generateDateList = exports.formatTime = exports.formatDateTime = exports.formatDate = void 0;
...
var generateDateList = function generateDateList() {
  var daysAhead = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 7;
  var dates = [];
...
var isVenueOpen = function isVenueOpen(venue) {
...
exports.isVenueOpen = isVenueOpen;
...
/* 77 */
/*!**************************************************!*\
  !*** D:/项目/球馆/miniapp/composables/useBooking.ts ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.useBookingStatus = useBookingStatus;
exports.useQrCode = useQrCode;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 47));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 49));
var _vue = __webpack_require__(/*! vue */ 4);
var _booking = __webpack_require__(/*! @/api/booking */ 78);
function useBooking() {
  var bookings = (0, _vue.ref)([]);
  var currentBooking = (0, _vue.ref)(null);
  var loading = (0, _vue.ref)(false);
  var submitting = (0, _vue.ref)(false);
  var loadBookings = /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(status) {
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return (0, _booking.getMyBookings)(status !== null && status !== void 0 ? status : null);
            case 4:
              bookings.value = _context.sent;
              _context.next = 10;
              break;
            case 7:
              _context.prev = 7;
    ...
    return function loadBookings(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  var loadBookingDetail = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(bookingNo) {
      return _regenerator.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return (0, _booking.getBookingDetail)(bookingNo);
            case 4:
              currentBooking.value = _context2.sent;
              _context2.next = 10;
              break;
            case 7:
              _context2.prev = 7;
    ...
    return function loadBookingDetail(_x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  var submitBooking = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return (0, _booking.createBooking)(params);
            case 4:
              result = _context3.sent;
              return _context3.abrupt("return", result.bookingNo);
            case 8:
              _context3.prev = 8;
              _context3.t0 = _context3["catch"](1);
              console.error(_context3.t0);
    ...
    return function submitBooking(_x3) {
      return _ref3.apply(this, arguments);
    };
  }();
  var cancelBooking = /*#__PURE__*/function () {
    var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(bookingNo, reason) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return (0, _booking.cancelBooking)(bookingNo, reason);
            case 3:
    ...
    return function cancelBooking(_x4, _x5) {
...
function useQrCode() {
  var qrCodeUrl = (0, _vue.ref)('');
  var qrExpireAt = (0, _vue.ref)(null);
  var refreshQrCode = /*#__PURE__*/function () {
    var _ref5 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5(bookingNo) {
      var result;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return (0, _booking.getQrCode)(bookingNo);
            case 3:
              result = _context5.sent;
              qrCodeUrl.value = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=".concat(encodeURIComponent(result.token));
    ...
    return function refreshQrCode(_x6) {
...
/* 78 */
/*!***************************************!*\
  !*** D:/项目/球馆/miniapp/api/booking.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getRecommendations = exports.getQrCode = exports.getMyBookings = exports.getBookingDetail = exports.createBooking = exports.cancelBooking = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 51));
...
var cancelBooking = function cancelBooking(bookingNo, reason) {
  return (0, _request.default)({
    url: "/bookings/".concat(bookingNo, "/cancel"),
    method: 'POST',
    data: {
      reason: reason
    }
...
var getBookingDetail = function getBookingDetail(bookingNo) {
  return (0, _request.default)({
    url: "/bookings/".concat(bookingNo)
  });
};
exports.getBookingDetail = getBookingDetail;
var getMyBookings = function getMyBookings(status) {
  return (0, _request.default)({
    url: '/bookings/my',
    data: status ? {
      status: status
...
var getQrCode = function getQrCode(bookingNo) {
  return (0, _request.default)({
    url: "/qrcode/booking/".concat(bookingNo)
  });
};
exports.getQrCode = getQrCode;
var getRecommendations = function getRecommendations(data) {
  return (0, _request.default)({
    url: '/recommendations',
    method: 'POST',
    data: data
...
/* 95 */
/*!***********************************************!*\
  !*** D:/项目/球馆/miniapp/composables/useAuth.ts ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 49));
var _vue = __webpack_require__(/*! vue */ 4);
var _auth = __webpack_require__(/*! @/api/auth */ 96);
function useAuth() {
  var token = (0, _vue.ref)(uni.getStorageSync('token') || '');
  var userInfo = (0, _vue.ref)(uni.getStorageSync('userInfo') || null);
  var isLoggedIn = (0, _vue.computed)(function () {
    return !!token.value;
  });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.next = 6;
              return (0, _auth.wechatLogin)(loginRes.code);
            case 6:
...
function useUserType() {
  ...
  var getUserTypeName = function getUserTypeName(type) {
...
exports.wechatLogin = exports.updateUserProfile = exports.getUserProfile = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request */ 51));
var wechatLogin = function wechatLogin(code) {
  return (0, _request.default)({
